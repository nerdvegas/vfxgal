#ifndef _SOP_VORONOI_FRACTURE__H_
#define _SOP_VORONOI_FRACTURE__H_

#include <OpenEXR/ImathVec.h>
#include <SOP/SOP_Node.h>

#define SOP_NAME "vfxgal_voronoi_fracture"
#define SOP_LABEL "vfxgal Voronoi Fracture"
...
namespace vfxgal_hou
{
	...
	protected:
		SOP_VoronoiFracture(OP_Network *net, const char *name, OP_Operator *op);
		virtual ~SOP_VoronoiFracture(){}
