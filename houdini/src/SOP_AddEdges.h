#ifndef _SOP_ADDEDGES__H_
#define _SOP_ADDEDGES__H_

#include <OpenEXR/ImathVec.h>
#include <SOP/SOP_Node.h>

#define SOP_NAME "vfxgal_add_edges"
#define SOP_LABEL "vfxgal Add Edges"
...
namespace vfxgal_hou
{
	...
	protected:
		SOP_AddEdges(OP_Network *net, const char *name, OP_Operator *op);
		virtual ~SOP_AddEdges(){}
